    ...
    <div class="card-body card-block">
      <div class="row">
        ...
        <div class="col col-lg-6 col-md-8 col-sm-12 border border-secondary ml-5 mr-2">
          ...
          <hr>
          <form action="{{ route('messages.chat.store', [$message->id, $auth_id, $message->message_uuid]) }}" method="POST">
            <div class="row">
              @csrf
      ...
      <div class="row">
        <div class="col col-lg-6 col-md-6 col-sm-6">
          <a class="btn btn-primary text-white mt-3 btn-block" href="{{ route('messages') }}"><i class="fa fa-reply mr-2"></i>Back to List</a>
        </div>
        <div class="col col-lg-6 col-md-6 col-sm-6">
          <a class="btn btn-danger text-white mt-3 btn-block" href="{{route('messages.chat.close', $message->id)}}"><i class="fa fa-ban mr-2"></i>Close Conversation</a>
        </div>
      </div>
    </div>
  </div>
