    ...
    <div class="card-body card-block">
      ...
      <form action="{{route('reviews.update', $review->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <label for="name" class="form-control-label">Reviewer</label>
          <input type="text" name="name" id="name" value="{{ $review->user->name }}" class="form-control  @error('name') is-invalid @enderror" readonly>
