        ...
        <div class="card-body">
          <div class="row">
            <div class="col col-lg-8 col-md-8 col-sm-12">
              ...
              <a href="{{route('user.returns.create')}}" class="btn btn-primary btn-sm d-inline-block" style="margin-top: -8px"><i class="fa fa-plus mr-2"></i>Apply</a>
            </div>
            <div class="col col-lg-4 col-md-4 col-sm-12">
              <div class="right-align">
                <form action="{{route('user.returns.search')}}" method="GET">
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{route('user.returns.show', $product->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-info-circle"></i></a>
                  </td>
                </tr>
